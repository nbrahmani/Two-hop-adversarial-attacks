...
from utils.definitions_tokenizer import get_tokenizer
from utils.wordnet import synset_from_offset
from utils.wsd import WSDInstance
from esc_dataset import WordNetDataset, OxfordDictionaryDataset
from esc_pl_module import ESCModule
from utils.commons import list_elems_in_dir
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--prediction-path", type=str, required=True, nargs="+")
...
def main() -> None:
    ...
    for prediction_type in args.prediction_types:
        for dataset_path in dataset_paths:
            ...
            predictions_path = f"{args.prediction_path[0]}/{ntpath.basename(dataset_path)}_predictions.txt"
            output_errors_path = (
